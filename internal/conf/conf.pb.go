...
type Log struct {
	...
	LogLevel      LogLevel               `protobuf:"varint,2,opt,name=log_level,json=logLevel,proto3,enum=kratos.api.LogLevel" json:"log_level,omitempty"`
...
const file_conf_proto_rawDesc = "" +
	...
	"\rwrite_timeout\x18\x04 \x01(\v2\x19.google.protobuf.DurationR\fwriteTimeout\"\xd4\x01\n" +
	"\x03Log\x12\x19\n" +
	"\blog_path\x18\x01 \x01(\tR\alogPath\x121\n" +
	"\tlog_level\x18\x02 \x01(\x0e2\x14.kratos.api.LogLevelR\blogLevel\x12\x19\n" +
	...
	"\x05Fatal\x10\x04B\x9a\x01\n" +
	"\x0ecom.kratos.apiB\tConfProtoP\x01Z4github.com/kkhnifes/kratos-layout/internal/conf;conf\xa2\x02\x03KAX\xaa\x02\n" +
	"Kratos.Api\xca\x02\n" +
...
var file_conf_proto_depIdxs = []int32{
	...
	0,  // 7: kratos.api.Log.log_level:type_name -> kratos.api.LogLevel
